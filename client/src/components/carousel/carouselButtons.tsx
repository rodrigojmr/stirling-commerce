...
export const SliderButton = ({ children, ...props }: SliderButtonProps) => (
  <Box
    as="button"
    position="absolute"
    zIndex="1"
    ...
    sx={{
      ...
      ':hover:not(:disabled), :focus': {
        backgroundColor: 'rgba(209, 209, 209, 0.411)',
        fill: '#89f2d2'
      },
      '&:disabled': {
        fill: '#868686'
